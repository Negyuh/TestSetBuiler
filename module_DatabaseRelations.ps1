...
foreach($ci in (1..($amountall+ ([int]$anmnw * [int]$amntsource) + $new))){
    Set-Variable -Name "CISIDtmp" -Value (-join ((48..57) + (97..122) | Get-Random -Count 32 | ForEach-Object {[char]$_}))
    [array]$cisid += $cisidtmp
    Set-Variable -Name "CISIDtmp2" -Value (-join ((48..57) + (97..122) | Get-Random -Count 32 | ForEach-Object  {[char]$_}))
    [array]$cisid2 += $cisidtmp2
    Set-Variable -Name "CISIDtmp3" -Value (-join ((48..57) + (97..122) | Get-Random -Count 32 | ForEach-Object {[char]$_}))
    ...
    Set-Variable -Name "serial" -Value (-join ((48..57)  | Get-Random -Count 32 | ForEach-Object {[char]$_}))
    [array]$serialnumber += "$serial"
    Set-Variable -Name "altserial" -Value (-join ((48..57) + (97..122) | Get-Random -Count 10 | ForEach-Object {[char]$_}))
